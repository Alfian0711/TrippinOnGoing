...
class Regist extends StatelessWidget {
 Regist({super.key,this.credential});
	                ...
	                children: <Widget>[
	                  ...
	                  Positioned(
	                    child: FadeInUp(duration: Duration(milliseconds: 1600), child: Container(
	                      ...
	                      child: Center(
	                        child: Text("Regist", style: TextStyle(color: Colors.white, fontSize: 65, fontWeight: FontWeight.bold),),
	                      ),
	                    )),
	                  )
	                ],
	              ...
	              child: Column(
	                children: <Widget>[
	                  FadeInUp(duration: Duration(milliseconds: 1800), child: Container(
                        ...
                        border: Border.all(color: Color.fromRGBO(187, 232, 194, 1),),
	                      boxShadow: [
	                        BoxShadow(
	                    ...
	                    child: Column(
	                      children: <Widget>[
                           Container(
	                          ...
	                          decoration: BoxDecoration(
	                            border: Border(bottom: BorderSide(color:  Color.fromRGBO(187, 232, 194, 1),))
	                          ),
	                          child: TextField(
